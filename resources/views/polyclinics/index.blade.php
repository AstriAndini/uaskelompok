...
<a href="{{ route('polyclinics.create') }}" class="btn btn-info mt-3">Tambah Data Poliklinik</a>
<div class="col-sm-12">
...
<div class="card-body">
    <table class="table table-stripped table-teal">
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('polyclinics.edit', $polyclinic->id) }}" class="btn btn-secondary">Edit</a>
            </td>
            <td>
